...
from evaluation.evaluator import evaluate_recursive_panel_log_diff
...
config.output_dir = f'../outputs/multi_step_log_diff_lag{config.diff_lag}'
...
test_preds_inv, test_actuals_inv, test_dates = evaluate_recursive_panel_log_diff(
    final_model, train_scaled, test_scaled, config, target_scaler, device, raw_test_df
)
